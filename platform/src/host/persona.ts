...
export const PERSONAS: Persona[] = [
  {
    ...
    greeting: 'おかえりなさいませ。お困りごとはありませんか？長屋のことなら何でもお聞きくださいね。',
    personality:
  ...
  },
  {
    ...
    greeting: 'あ、いらっしゃい！何か手伝えることはありますか？遠慮なく言ってくださいね。',
    personality:
  ...
  },
  {
    ...
    blurb: '元気いっぱいの見習い小僧',
    greeting: 'いらっしゃいませ！丁稚のわたしが何でもお手伝いします。さ、何をしましょう！',
    personality:
  ...
  },
  {
    ...
    blurb: '生真面目で物知りな学生さん',
    greeting: 'ようこそ。長屋の使い方でも道具のことでも、順を追ってご説明しますよ。',
    personality:
  ...
  },
  {
    ...
    greeting: 'おかえりなさいませ、ご主人様。本日は何をお手伝いいたしましょう？',
    personality:
  ...
  },
  {
    ...
    blurb: '落ち着いて品のある執事',
    greeting: 'お帰りをお待ちしておりました。ご用の際は、いつでもお申し付けくださいませ。',
    personality:
  ...
  },
  {
    ...
    blurb: 'てきぱき有能なビジネス秘書',
    greeting: 'おつかれさまです。ご用件をどうぞ。すぐにお調べします。',
    personality:
  ...
  },
  {
    ...
    blurb: '経験豊富で頼れる商家の番頭',
    greeting: 'よう、いらっしゃい。困りごとがありゃ、この番頭にまかせておくんなさい。',
    personality:
  ...
  },
  {
    ...
    greeting: 'おや、よく来たね。まあ座って。困ったことがあったら何でも聞いておくれ。',
    personality:
  ...
  },
  {
    ...
    greeting: 'うむ、来たね。まあゆっくりしていきなさい。用があれば言っておくれ。',
    personality:
